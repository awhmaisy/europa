  ...
  return (
    <main>
      ...
      <div className="content">
        ...
        <h4>japanese language & culture</h4>
        <ul>
          <li>電気 (denki) - electricity/light</li>
          <li>つけて (tsukete) - turn on/light up</li>
          <li>! - imperative/command particle</li>
        </ul>
        ...
        <h4>in tech & design</h4>
        <ul>
          <li>UI/UX illumination patterns</li>
          <li>digital accessibility</li>
          <li>interface design principles</li>
          <li>user experience lighting</li>
        </ul>
